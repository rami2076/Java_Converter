package org.fx.tool.view.base.generate.field.view_field_bean_field;
...
public class ViewFieldToBeanFieldController implements Initializable {
    ...
    private void initPromptText() {
        inputTextArea.setPromptText(
                "例\r" +
                        ...
                        "\r" +
                        "/** オブジェクト　*/\r" +
                        "private DecimalField object;\r"+
                        "\r" +
                        "/** 選択肢A　*/\r" +
                        "private CheckBox 選択肢A;\r"+
                        "\r" +
                        "/** カスタムコンボボックス　*/\r" +
                        "private CustumCombBox カスタムコンボボックス;\r"+
                        "\r" +
                        "/** カスタムDateTimePikcer　*/\r" +
                        "private CustumDateTimePikcer カスタムコンボボックス;\r"+
                        "\r" +
                        "/** テキストフィールド　*/\r" +
                        "private TextFiled カスタムコンボボックス;\r"+
                        "\r" +
                        "/** パスワードフィールド　*/\r" +
                        "private PassWordFiled カスタムコンボボックス;\r"
        );
